...
import { topicArchiveSchema } from "@/lib/validations/phase9"
import { isActiveAdmin, mapTopicsError } from "../../_shared"
...
export async function POST(request: NextRequest, context: RouteContext) {
  try {
    ...
    const validation = topicArchiveSchema.safeParse(body)
    ...
    console.error("Erreur topics/[id]/archive POST:", error)
